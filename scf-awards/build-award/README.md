...
2. **Referral Confirmation and Eligibility Review**\
   SCF relies heavily on signals from our referrers to determine eligibility. If you listed an SCF referrer, they’ll be asked to confirm that referral and to provide any relevant context about your project. Though a referral is not mandatory to receive an SCF award, SCF relies heavily on referral signals. [Learn more about the referral program here.](./README.md#scf-build-referral-program)\
   \
